...
class FourthViewController: UIViewController {
    ...
    var fiboAdder = fiboAdderClass(fibo1: 0, fibo2: 1, fiboFinal: 1, indexNumb: 0)
...
/*
    ...
    @IBAction func calculateButton(sender: AnyObject) ->String  {
        self.labelOutput.text = String(self.fiboAdder.fibonacciNumberAtIndex(<#T##indexOfFibonacciNumber: Int##Int#>))
